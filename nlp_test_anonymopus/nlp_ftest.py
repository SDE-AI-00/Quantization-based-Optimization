###########################################################
# nlp_ftest.py
# Main NLP test code for functions in pybencgfunction
# axel.arcueil@gmail.com
###########################################################
from pybenchfunction.function import Ackley
import numpy as np
...
if __name__ == '__main__':
    _dim = 2
    Ackley = sphere = bench.function.Ackley(_dim)
